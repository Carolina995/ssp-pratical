	...
	<xsl:template match="/">
		<html>
			...
			<body>
				...
				<p>Select your entrees from the menu below. To watch the movie, click the Watch it button. Check the "Highlight " box to highlight decaf drinks.</p>
						...
						<xsl:for-each select="//category">
							...
							<xsl:for-each select="movie">
								<tr>
									...
									<td align="center">
										<input name="movie0" type="checkbox"/>
									</td>
									<td>
										<xsl:value-of select="name"/>
									</td>
				...
				<form class="indent">
					<p><input type="button" name="btnWatchit" value="Watch Movie" id="watchMovie"/>
                Watch it
                <input type="text" name="txtAnimationM"/><input type="checkbox" name="cbOpts" value="isAnimation" id="showAnimation"/><label for="showAnimation">Highlight Animation</label></p>
				</form>
			</body>
		</html>
	</xsl:template>
